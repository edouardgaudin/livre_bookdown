...
9. Taper git remote add suivi du nom que vous souhaitez donner à la connection suivi de l'url github de votre repo copiée précedémment, soit quelque chose comme:
